                ...
                child: Container(
                  child: StreamBuilder(
                      stream: FirebaseFirestore.instance
                          .collection("products").orderBy("product-titre")
                          .where("product-titre",
                              isGreaterThanOrEqualTo: inputText.toLowerCase()).where("product-titre",isLessThanOrEqualTo: inputText.toLowerCase()+"\uf8ff")
                          .snapshots(),
                        ...
                        return ListView(
                          children: snapshot.data!.docs
                            ...
                            return Card(
                              elevation: 5,
                              child: ListTile(
                                onTap: ()=>Navigator.push(context, MaterialPageRoute(builder: (_)=>ProductDetails(data))),
